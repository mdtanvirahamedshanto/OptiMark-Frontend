    ...
    >
      <div
        ...
        style={{
          ...
          transform: questionCount === 100 ? "scale(0.88)" : "scale(0.94)",
          transformOrigin: "top center",
          marginBottom: questionCount === 100 ? "-130px" : "-60px",
        }}
      >
        {/* Markers */}
        {/* Top Left Marker */}
            ...
            {infoType === "Digital" ? (
                      ...
                      <tr>
                        {Array.from({ length: 6 }).map((_, i) => (
                          <td
                            ...
                            style={{
                              borderRight:
                                i === 5 ? "none" : `1px solid ${theme.border}`,
                            }}
                          ></td>
                        ))}
                      </tr>
                          ...
                          {Array.from({ length: 6 }).map((_, col) => (
                            <td
                              ...
                              style={{
                                ...
                                verticalAlign: "middle",
                                backgroundColor:
                                  col % 2 === 0 ? theme.bg300 : "transparent",
                              }}
                            >
                              <div
                                style={{
                      ...
                      <tr>
                        {Array.from({ length: 3 }).map((_, i) => (
                          <td
                            ...
                            style={{
                              borderRight:
                                i === 2 ? "none" : `1px solid ${theme.border}`,
                            }}
                          ></td>
                        ))}
                      </tr>
                ...
                >
                  <div>
                    ...
                    >
                      ...
                      <p style={{ margin: "0 0 4px 0" }}>
                        ২। উত্তরপত্রে অবাঞ্চিত দাগ দেয়া যাবেনা।
                      </p>
                      <p style={{ margin: "0 0 4px 0" }}>
                        ৩। উত্তরপত্র ভাজ করা যাবেনা।
                      </p>
                      <p style={{ margin: "0 0 4px 0" }}>
              ...
              <div style={{ width: "100%" }}>
                ...
                >
                  ...
                  <div
                    style={{ flex: 1, paddingLeft: "8px", paddingTop: "8px" }}
                  >
                  ...
                  >
                    ...
                    >
                      ...
                      <p style={{ margin: "0 0 2px 0" }}>
                        ২। উত্তরপত্রে কোন অবাঞ্ছিত দাগ দেয়া যাবেনা।
                      </p>
                      <p style={{ margin: "0 0 2px 0" }}>
                        ৩। উত্তরপত্র কোন ভাবেই ভাজ করা যাবেনা।
                      </p>
                      <p style={{ margin: "0" }}>
                        ৪। সেট কোড না ভরাট করলে উত্তরপত্র বাতিল হবে।
                      </p>
                    </div>
                    <div
                      style={{
                  ...
                  >
                    <span
                      style={{
                        ...
                        borderBottom: `1px solid ${theme.text600}`,
                        paddingBottom: "2px",
                      }}
                    >
                      পরীক্ষার্থীর তথ্য
                ...
                >
                  <div>
                    ...
                    >
                      ...
                      <p style={{ margin: "0 0 4px 0" }}>
                        ২। উত্তরপত্রে অবাঞ্চিত দাগ দেয়া যাবেনা।
                      </p>
                      <p style={{ margin: "0 0 4px 0" }}>
                        ৩। উত্তরপত্র ভাজ করা যাবেনা।
                      </p>
          ...
          >
            ...
            >
              ...
              >
                ...
                <div
                  style={{ display: "flex", gap: "8px", marginRight: "2px" }}
                >
                  <div
                    style={{
                      height: "20px",
              ...
              >
                {/* Left Inner Side Timing Marks - Aligned to rows */}
                <div
                  style={{
                    display: "flex",
                    flexDirection: "column",
                ...
                <div style={{ display: "flex", gap: "8px", zIndex: 10 }}>
                  {columns.map((columnQuestions, colIdx) => (
                    <div key={`col-${colIdx}`} style={{ display: "flex" }}>
                ...
                {/* Right Inner Side Timing Marks - Aligned to rows */}
                <div
                  style={{
                    display: "flex",
                    flexDirection: "column",
